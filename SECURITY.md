...
AmneziaVPN, минимального сценария воспроизведения и обезличенного лога.

Перед публикацией лога замените адреса и домены на значения из
`192.0.2.0/24`, `198.51.100.0/24`, `203.0.113.0/24` и `example.com`.

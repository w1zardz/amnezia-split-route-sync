...
|---|---:|---:|---:|---:|
| `mobile-whitelist-cidr` | 30228 | 265 | 0 | 0 |
...
| `lib4u-amnezia` | 1535 | 261 | 1954 | 110 |

После объединения внутри проверенных диапазонов IP→ASN принято сетей: **226** (потолок 1600).

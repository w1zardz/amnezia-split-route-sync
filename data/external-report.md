...
Сборка 2026-09-11. Файл генерируется `tools/import_external.py`, правки руками бессмысленны.
...
| `lib4u-amnezia` | 1494 | 264 | 1954 | 106 | 1042 |
| `v2fly-ru` | 0 | 0 | 1741 | 9 | 997 |
| `jirnobruh-amnezia` | 768 | 142 | 925 | 176 | 305 |
| `kyoresuas-ru-bypass` | 8800 | 725 | 0 | 0 | 0 |
| `kyoresuas-essential` | 313 | 70 | 0 | 0 | 0 |
| `pincetgore-ip-list` | 1424 | 224 | 0 | 0 | 0 |
...
| Причина | Сетей |
|---|---|
| не российская сеть | 24355 |
| ASN не обслуживает ни один сервис каталога | 13344 |
| нет в таблице IP→ASN или сеть не анонсируется | 5904 |
| сеть пересекает разные ASN | 4292 |
| уже покрыто снапшотом | 2917 |
| адресное пространство оператора связи | 2860 |
| глобальный CDN или облако | 1456 |
| не публичная сеть | 19 |
| шире допустимой /12 | 8 |

Зарубежные сети по странам: US — 5236, GB — 1884, TR — 1752, DE — 1628, FR — 1196, NL — 1014, IT — 991, CH — 932, SE — 714, ES — 608, AT — 569, PL — 466. Именно ради этих записей и написан фильтр: попади они в direct, часть трафика ушла бы мимо VPN с домашнего адреса.

...
Сборка 2026-08-10. Файл генерируется `tools/import_external.py`, правки руками бессмысленны.
...
После схлопывания в анонсируемые префиксы принято сетей: **190** (потолок 1600).

## Почему отсеяно

| Причина | Сетей |
|---|---|
| не российская сеть | 22579 |
| нет в таблице IP→ASN или сеть не анонсируется | 2352 |
| ASN не обслуживает ни один сервис каталога | 1373 |
| сеть лежит в двух разных ASN | 1351 |
| адресное пространство оператора связи | 1306 |
| глобальный CDN или облако | 665 |
| уже покрыто снапшотом | 379 |

Зарубежные сети по странам: US — 5067, GB — 1745, TR — 1726, DE — 1522, FR — 1167, IT — 955, NL — 923, CH — 809, SE — 681, AT — 559, ES — 556, PL — 459. Именно ради этих записей и написан фильтр: попади они в direct, часть трафика ушла бы мимо VPN с домашнего адреса.

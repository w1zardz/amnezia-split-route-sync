...
Сборка 2026-09-07. Файл генерируется `tools/import_external.py`, правки руками бессмысленны.
...
| Причина | Сетей |
|---|---|
| не российская сеть | 22599 |
| нет в таблице IP→ASN или сеть не анонсируется | 2328 |
...
| уже покрыто снапшотом | 380 |

Зарубежные сети по странам: US — 5063, GB — 1749, TR — 1726, DE — 1524, FR — 1167, IT — 970, NL — 920, CH — 808, SE — 680, AT — 559, ES — 556, PL — 459. Именно ради этих записей и написан фильтр: попади они в direct, часть трафика ушла бы мимо VPN с домашнего адреса.

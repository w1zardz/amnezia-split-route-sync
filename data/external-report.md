...
Сборка 2026-08-24. Файл генерируется `tools/import_external.py`, правки руками бессмысленны.

## Источники

| Источник | Записей | Прошло проверку |
|---|---|---|
| `mobile-whitelist-cidr` | 30228 | 291 |
...
| Причина | Сетей |
|---|---|
| не российская сеть | 22602 |
| нет в таблице IP→ASN или сеть не анонсируется | 2330 |
| ASN не обслуживает ни один сервис каталога | 1374 |
| сеть лежит в двух разных ASN | 1346 |
| адресное пространство оператора связи | 1306 |
| глобальный CDN или облако | 668 |
| уже покрыто снапшотом | 378 |

Зарубежные сети по странам: US — 5068, GB — 1746, TR — 1726, DE — 1523, FR — 1167, IT — 970, NL — 921, CH — 809, SE — 680, AT — 559, ES — 556, PL — 459. Именно ради этих записей и написан фильтр: попади они в direct, часть трафика ушла бы мимо VPN с домашнего адреса.
